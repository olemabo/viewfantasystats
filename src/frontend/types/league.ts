...
export const isLeaguePath = (path: string): path is LeaguePath =>
  path in LeagueTypeByPath;

export const mapPathToLeagueType = (path: string): LeagueType =>
  isLeaguePath(path) ? LeagueTypeByPath[path] : LeagueTypes.FPL;