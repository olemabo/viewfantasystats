...
//     isLoading,
//     errorLoading,
//   } = useRankStatistics(lastNumberOfYears, props.languageContent);
...
//   const ranksFiltered = sortAndFilterRankData(
//     ranks,
//     query,
//     sortType,
//     decreasing,
...
//             <label>
//               {props.languageContent.Statistics.RankStatistics.last_season}
//             </label>
//             <select
//               onChange={(e) => changeLastXYears(parseInt(e.target.value))}
//               className="input-box"
//               id="sort_on_dropdown"
//               name="sort_on"
//             >
...
//                 >
//                   {i == 0 &&
//                     props.languageContent.General.previous +
//                       " " +
//                       props.languageContent.General.season}
//                   {i > 0 &&
//                     props.languageContent.General.last +
//                       " " +
//                       (i + 1).toString() +
//                       " " +
//                       props.languageContent.General.seasons}
//                 </option>
//               ))}
//             </select>
//           </div>
...
//                     <TableCell cellType="head" className="narrow">
//                       {props.languageContent.General.rank}
//                     </TableCell>
//                     <TableCell cellType="head" className="name-col">
//                       {props.languageContent.General.teamname}
//                     </TableCell>
//                     <TableCell cellType="head" minWidth={145}>
//                       <TableSortHead
//                         defaultSortType={"Increasing"}
//                         text={
//                           props.languageContent.Statistics.RankStatistics.rank
//                         }
//                         reset={sortType !== "Rank"}
...
//                       <TableSortHead
//                         text={
//                           props.languageContent.Statistics.RankStatistics.points
//                         }
...
//                           {sortType == "Rank"
//                             ? x.avg_rank_ranking
//                             : x.avg_points_ranking}
//                         </TableCell>
//                         <TableCell cellType="data" className="name-col">
//                           <Link
//                             href={fantasyManagerUrl.replace("X", x.user_id)}
//                             target="_blank"
//                           >
//                             {x.team_name}
//                           </Link>
//                         </TableCell>
//                         <TableCell cellType="data" minWidth={145}>
//                           {x.avg_rank}
//                         </TableCell>
//                         <TableCell cellType="data" minWidth={145}>
//                           {x.avg_points}{" "}
