...
export default async function FixturePlannerHeader({
  fixturePlanningType,
  leagueType,
  ...
  return (
    <h1>
      ...
      >
        ...
        {leagueType === esf && (
          <>
            <a href={URLS.EXTERNAL.SPREADSHEETS.DAGFINN_THON}>
              {t("Fixture.ExcelSheet")}
            </a>
  ...
  switch (fixturePlanningType) {
    case fdrRotation:
      ...
      description = t("Fixture.RotationPlanner.PageDescription.Text", {
        title,
        rotationPlannerDescription_first: t(
          "Fixture.RotationPlanner.PageDescription.Description1",
        ),
        rotationPlannerDescription_second: t(
          "Fixture.RotationPlanner.PageDescription.Description2",
        ),
        gw_start,
        and: t("General.and"),
        gw_end,
        ...
        rotationPlannerDescription_1: t(
          "Fixture.RotationPlanner.PageDescription.Description3",
        ),
        teams_to_play: t("Fixture.teams_to_play"),
        rotationPlannerDescription_2: t(
          "Fixture.RotationPlanner.PageDescription.Description4",
        ),
      });
      break;
    case fdrPeriode:
