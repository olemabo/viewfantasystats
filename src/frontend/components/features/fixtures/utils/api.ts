...
// import { getESFFixtureData } from "../fixture-planner/esf-api";
// import { getTeamDataESF, getTeamDataFPL } from "../../../pages/rotation-planner/api";
// import { getFixtureDataFPLServerFPL } from "../../../../lib/api/fixture-planner/fixture-planner";
// import { getKickoffTimesESF, getKickoffTimesFPL } from "../../../../lib/api/kickoff-times/kickoff-times";
...
//     if (leagueType === esf) {
//         return await getESFFixtureData(defaultForm);
//     }
