...
import { Increasing, TableSortHead } from '../../shared/ui/tableSortHead/TableSortHead';
...
export function PriceChange({
    ...
    const priceChangeSorted =  sortAndFilterPriceChange(priceChangeData, query, sortingTeamId, sortingPositionId, sortType, decreasing);
        ...
        <form className="form-stuff price-change text-center">
                ...
                <div className='box-2'>
                    ...
                    >
                        ...
                        {teamData.length > 0 && teamData.map(x => (
