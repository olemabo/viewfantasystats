                                    ...
                                    <tr key={"fdr-row-" + fdr.team_name} id={"fdr-row-" + fdr.team_name}>
                                        { fdr.FDR.map(f => (
                                            ...
                                            + (f.fdr_gw_i.length == 1 ? " colors-" + f.fdr_gw_i[0].difficulty_score + " " : " no-padding ") + 'double-border-' + f.fdr_gw_i[0].Use_Not_Use  }>
                                                { f.fdr_gw_i.map(g => (
                                                    <div key={g.opponent_team_name + g.H_A} style={{
                                                        backgroundColor: convertFDRtoHex(f.fdr_gw_i[0].difficulty_score, fdrToColor),
                                                        position: g.message ? "relative" : "inherit",
                                                        color: contrastingColor(convertFDRtoHex(f.fdr_gw_i[0].difficulty_score, fdrToColor))}} 
                                                        ...
                                                        <Popover 
                                                            ...
                                                            iconSize={14}
                                                            className={ idx > (fdrData?.length - 4) ? 'bottom-position' : ''}
