...
export function FixturePlannerTeamIdPage({ 
    ...
    const [ teamID, setTeamId ] = useState(teamIdFromSearch ? parseInt(teamIdFromSearch) : 0);
    const [ teamIDCorrect, setTeamIdCorrect ] = useState(teamIdFromSearch ? parseInt(teamIdFromSearch) : 0);
    ...
    const { players, loading, error } = useFDRFromTeamId(teamIDCorrect, gwStart, leagueType);
    ...
    const playerNames = [g("goalkeeper"), g("defender"), g("midfielder"), g("forward")]
