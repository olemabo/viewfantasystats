...
from models.statistics.apiResponse.PlayerStatisticsApiResponse import PlayerStatisticsApiResponse, PlayerStatisticsApiResponseSerializer
...
class PlayerStatisticsAPIView(APIView):
    ...
    def get(self, request, format=None):
        try:
            ...
            serializer = PlayerStatisticsApiResponseSerializer(response)
