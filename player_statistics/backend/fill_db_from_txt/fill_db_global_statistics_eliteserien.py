...
def fill_db_extra_info_statistics_eliteserien(gw, file_path):
    top_x_players = all_top_x_players_eliteserien
...
def fill_db_nationality_statistics_eliteserien(gw, file_path):
    try:
        current_path = file_path + "/top_" + str(max(all_top_x_players_eliteserien)) + "/" + name_of_nationality_file
