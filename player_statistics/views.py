...
def get_sort_on_dict():
    return {"Name": "player_name", "Bps": "bonus_list",
            "ICT": "ict_index_list",
            "I": "influence_list",
            "C": "creativity_list",
            "T": "threat_list"}
...
@csrf_exempt
def show_player_statistics(request, last_x_rounds=6, sorting_keyword="All", sort_on="Name", acc_dec="-", last_x_gw="All GWs"):
    ...
    print(max_gws, last_x_gw, last_x_gws)
    context = {
