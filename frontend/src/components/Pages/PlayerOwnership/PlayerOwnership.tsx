...
export const PlayerOwnership: FunctionComponent<PageProps> = (props) => {
  ...
  const [topXPlayers, setTopXPlayers] = useState(
    props.topXManagersDefault ?? 10000,
  );
  ...
  console.log(chipUsageRound, chipUsageTotal);
  const {
    updatingGw,
    updatingPrecentage,
    topXPlayersList,
          ...
          <h1>
            ...
            >
              {props.leagueType === fpl
                ? props.languageContent.LongTexts.ownershiptDescriptionFPL
                : props.languageContent.LongTexts.ownershiptDescription}
            </Popover>
          </h1>
        )}
      >
        {updatingPrecentage > 0 && updatingGw > 0 && (
          <Message
            showCross={true}
            messageType="info"
            messageText={props.languageContent.Statistics.PlayerOwnership.is_updating_message
              ?.replace(
                "__PERCENTAGE__",
        ...
        <form className="form-stuff text-center">
          <div className="box-1">
            ...
            >
              <option value="All">
                {props.languageContent.General.all_players}
              </option>

              <option disabled style={{ fontWeight: 900 }}>
                {props.languageContent.General.by_position}
              </option>

              <option value="Goalkeepers">
                {props.languageContent.General.goalkeepers}
              </option>
              <option value="Defenders">
                {props.languageContent.General.defenders}
              </option>
              <option value="Midfielders">
                {props.languageContent.General.midfielders}
              </option>
              <option value="Forwards">
                {props.languageContent.General.forwards}
              </option>

              <option disabled style={{ fontWeight: 900 }}>
                {props.languageContent.General.by_team}
              </option>
          ...
          <div className="box-5">
            ...
            <input
              ...
              placeholder={
                props.languageContent.Statistics.PlayerOwnership.search_text
              }
              className="input-box"
              type="search"
              id="site-search"
              ...
              <TableHead>
                <TableRow>
                  <TableCell cellType="head" minWidth={139}>
                    {props.languageContent.Statistics.PlayerOwnership.player}
                  </TableCell>
                  <TableCell cellType="head">
                    <TableSortHead
                      popover_title="Effective Ownership"
                      popover_text={
                        props.languageContent.Popover.effectiveOwnership
                      }
                  ...
                  <TableCell cellType="head">
                    <TableSortHead
                      popover_title={
                        props.languageContent.Statistics.PlayerOwnership
                          .owned_by
                      }
                  ...
                  <TableCell cellType="head">
                    <TableSortHead
                      popover_title={
                        props.languageContent.Statistics.PlayerOwnership.captain
                      }
                  ...
                  <TableCell cellType="head">
                    <TableSortHead
                      text={
                        props.languageContent.Statistics.PlayerOwnership.benched
                      }
                  ...
                  <TableCell cellType="head" className="last-element">
                    <TableSortHead
                      ...
                      popover_text={
                        props.languageContent.Popover.topOwnership +
                        topXPlayers.toString() +
                        " " +
                        props.languageContent.General.managers +
                        "."
                      }
                      text={
                        props.languageContent.Statistics.PlayerOwnership
        ...
        {ownershipSorted.length === 0 && query && (
          <Message
            messageType="info"
            messageText={props.languageContent.General?.noHitsMessage}
          />
        )}
        ...
        {chipUsageRound?.length > 5 && (
          <div className="chips-section">
            <div>
              <Table tableLayoutType={props.leagueType} className="chips-table">
                <TableHead>
                  <TableRow>
                    <TableCell cellType="head" minWidth={chipsRoundTableWidth}>
                      ...
                      {props.languageContent.General.round_short}
                      {currentGW}
                    </TableCell>
                    <TableCell cellType="head">
                      {props.languageContent.Statistics.PlayerOwnership.percent}
                    </TableCell>
                  </TableRow>
                </TableHead>
                ...
                <TableBody>
                  ...
                  {props.leagueType === esf && chipUsageRound.length > 8 && (
                    <TableRow>
                      <TableCell
                        cellType="data"
                        minWidth={chipsRoundTableWidth}
                      >
                        {
                          props.languageContent.Statistics.PlayerOwnership
                            .park_the_bus
                      ...
                      <TableCell cellType="data">
                        {((chipUsageRound[8] / topXPlayers) * 100).toFixed(1)}{" "}
                        {"%"}
                      </TableCell>
                    </TableRow>
                  )}
            ...
            {chipUsageTotal && chipUsageTotal.length > 3 && (
              <div>
                <Table
                  tableLayoutType={props.leagueType}
                  className="chips-table"
                >
                  <TableHead>
                    <TableRow>
                      <TableCell
                        cellType="head"
                        minWidth={chipsAllRoundsTableWidth}
                      >
                        {
                          props.languageContent.Statistics.PlayerOwnership
                            .chip_total_usage_title
                        }
                      </TableCell>
                      <TableCell cellType="head">
                        {
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell cellType="data">
                        {(
                          (chipUsageTotal[props.leagueType === esf ? 3 : 4] /
                            topXPlayers) *
                          100
                        ).toFixed(1)}{" "}
                        {"%"}
                    ...
                    <TableRow>
                      ...
                      <TableCell cellType="data">
                        {(
                          (chipUsageTotal[props.leagueType === esf ? 4 : 3] /
                            topXPlayers) *
                          100
                        ).toFixed(1)}{" "}
                        {"%"}
                    ...
                    {props.leagueType === esf && (
                      <TableRow>
                        ...
                        <TableCell cellType="data">
                          {((chipUsageTotal[5] / topXPlayers) * 100).toFixed(1)}{" "}
                          {"%"}
                        </TableCell>
                      </TableRow>
                    )}
              ...
              <Table tableLayoutType={props.leagueType}>
                <TableHead>
                  <TableRow>
                    <TableCell
                      cellType="head"
                      minWidth={chipsTeamInfoTableWidthCol1}
                    >
                      {
                        props.languageContent.Statistics.PlayerOwnership
                          .team_info
                    ...
                    <TableCell
                      cellType="head"
                      minWidth={chipsTeamInfoTableWidthCol2}
                    >
                      {props.languageContent.Statistics.PlayerOwnership.value}
                    </TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
